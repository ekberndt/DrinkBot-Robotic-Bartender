...
def sawyer_client():
    ...
    try:
        ...
        ar_marker_11_base_added_xz.pose.position.y = ar_marker_11_base.pose.position.y + 0 * 0.0266
        ar_marker_11_base_added_xz.pose.position.z = ar_marker_11_base.pose.position.z + 0 * 0.0266
