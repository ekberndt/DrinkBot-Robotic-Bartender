    ...
    while not rospy.is_shutdown():
        ...
        while not rospy.is_shutdown():
            try:
                ...
                #x, y, and z position
                goal_1.pose.position.x = 0.803
                goal_1.pose.position.y = 0.273
                goal_1.pose.position.z = -0.099
        ...
        while not rospy.is_shutdown():
            try:
                ...
                #x, y, and z position
                goal_2.pose.position.x = 0.865
                goal_2.pose.position.y = -0.214
                goal_2.pose.position.z = -0.082
